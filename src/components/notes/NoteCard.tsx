...
export default function NoteCard({ note, onDelete, onEdit }: NoteCardProps) {
    ...
    return (
        <motion.div
            ...
            className="relative w-[300px] h-[300px] sm:w-[350px] sm:h-[350px] md:w-[400px] md:h-[400px] p-2"
        >
            <Image 
            ...
            <motion.h2
                ...
                className="text-center absolute top-[20%] left-1/2 -translate-x-1/2 text-white text-2xl font-bold " onClick={toggleCard}
            >
            ...
            <AnimatePresence>
                { isCardOpen && /* OVERLAY */
                    <motion.div
                        ...
                        onClick={toggleCard} className="flex justify-center items-center fixed right-0 top-0 h-screen w-screen bg-[#000000a2] backdrop-blur-[3px] backdrop-saturate-[100%] z-50 cursor-default"
                    >
                        <motion.div
                            ...
                            onClick={(e) => e.stopPropagation()} className="relative flex flex-col justify-center w-full sm:w-[28rem] md:w-[32rem] lg:w-[36rem] gap-3 p-5 pb-11 bg-[#121113] border-2 border-[#ffffff8a] hover:border-[#ffffffbe] rounded-2xl transition"
                        >
